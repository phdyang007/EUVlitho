...
#    morder=np.load(traindir+'inputlm/morder.npy')
    ...
    rea_train=np.load(traindir+'ampdata/rex.npy')
    ima_train=np.load(traindir+'ampdata/imx.npy')
    ...
    with open('factorx.csv','w') as ffactor:
    ...
    rea_val=np.load(valdir+'ampdata/rex.npy')
    ima_val=np.load(valdir+'ampdata/imx.npy')
