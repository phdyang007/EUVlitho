...
ndata=1   #number of the (mask, M3D parameters) data sets

NDIV=2048 # mask pattern size (nm)
NDIVM=512 # output mask pattern size, 4X4 averaging
ncut=1901 # number of the (l,m) pairs for a0
ncuts=1749 # number of the (l,m) pairs for ax and ay
